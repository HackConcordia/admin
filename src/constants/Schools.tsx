...
// School names are kept in their original form as they are proper nouns
export const Schools = (lang: Language = "en") => [
  {
  ...
  { value: "Abbey Park Middle School", label: "Abbey Park Middle School" },
  ...
  { value: "Academy at Palumbo", label: "Academy at Palumbo" },
  ...
  { value: "Agora Cyber Charter School", label: "Agora Cyber Charter School" },
  {
  ...
  { value: "AMC Engineering College", label: "AMC Engineering College" },
  { value: "American Heritage School", label: "American Heritage School" },
  ...
  { value: "Ancaster High School", label: "Ancaster High School" },
  { value: "Anchor Bay High School", label: "Anchor Bay High School" },
  {
  ...
  { value: "APS College of Engineering", label: "APS College of Engineering" },
  {
  ...
  { value: "Assam Downtown University", label: "Assam Downtown University" },
  { value: "Assam Engineering College", label: "Assam Engineering College" },
  { value: "Assam University, Silchar", label: "Assam University, Silchar" },
  ...
  { value: "Avon High School", label: "Avon High School" },
  {
  ...
  },
  {
    ...
    label: "Bahria University Lahore Campus",
  },
  ...
  { value: "Battlefield High School", label: "Battlefield High School" },
  {
    value: "Bauman Moscow State Technical University",
    label: "Bauman Moscow State Technical University",
  },
  { value: "Bayside High School", label: "Bayside High School" },
  { value: "Bayview Secondary School", label: "Bayview Secondary School" },
  ...
  { value: "Bergen County Academies", label: "Bergen County Academies" },
  {
  ...
  { value: "Blue Mountain Academy", label: "Blue Mountain Academy" },
  {
  ...
  { value: "BMIET, Sonipat", label: "BMIET, Sonipat" },
  {
  ...
  { value: "Brentsville High School", label: "Brentsville High School" },
  { value: "Briar Cliff University", label: "Briar Cliff University" },
  { value: "Briarcliff High School", label: "Briarcliff High School" },
  {
  ...
  { value: "Brooklyn College, CUNY", label: "Brooklyn College, CUNY" },
  {
    value: "Brooklyn Technical High School",
    label: "Brooklyn Technical High School",
  },
  { value: "Brookwood High School", label: "Brookwood High School" },
  ...
  { value: "C. D. Hylton High School", label: "C. D. Hylton High School" },
  {
  ...
  { value: "Cadbury Sixth Form College", label: "Cadbury Sixth Form College" },
  ...
  { value: "Canada (Cañada) College", label: "Canada (Cañada) College" },
  {
    value: "Canara Engineering College (CEC)",
    label: "Canara Engineering College (CEC)",
  },
  { value: "Canyon Crest Academy", label: "Canyon Crest Academy" },
  {
  ...
  { value: "Carteret High School", label: "Carteret High School" },
  { value: "Carthage College", label: "Carthage College" },
  { value: "Cascadia College", label: "Cascadia College" },
  {
  ...
  { value: "Cedar Creek High School", label: "Cedar Creek High School" },
  { value: "Cedar Ridge High School", label: "Cedar Ridge High School" },
  { value: "Cedarville University", label: "Cedarville University" },
  { value: "Cégep André-Laurendeau", label: "Cégep André-Laurendeau" },
  { value: "Cégep de Saint-Laurent", label: "Cégep de Saint-Laurent" },
  { value: "Cégep du Vieux Montréal", label: "Cégep du Vieux Montréal" },
  { value: "Cégep Marie-Victorin", label: "Cégep Marie-Victorin" },
  { value: "Cégep Gérald-Godin", label: "Cégep Gérald-Godin" },
  {
    value: "Cégep Saint-Jean-sur-Richelieu",
    label: "Cégep Saint-Jean-sur-Richelieu",
  },
  {
    value: "Centennial Collegiate Vocational Institute",
    label: "Centennial Collegiate Vocational Institute",
  },
  { value: "Centennial High School", label: "Centennial High School" },
  {
  ...
  { value: "Chaparral Star Academy", label: "Chaparral Star Academy" },
  { value: "Chapel Hill High School", label: "Chapel Hill High School" },
  {
  ...
  { value: "Cherokee High School", label: "Cherokee High School" },
  {
  ...
  { value: "Cheyney University", label: "Cheyney University" },
  {
  ...
  { value: "Christ Knowledge City", label: "Christ Knowledge City" },
  ...
  { value: "City Neighbors High School", label: "City Neighbors High School" },
  ...
  { value: "Clarksburg High School", label: "Clarksburg High School" },
  ...
  { value: "Clifton Public Highschool", label: "Clifton Public Highschool" },
  {
  ...
  { value: "CMR Engineering College", label: "CMR Engineering College" },
  {
  ...
  },
  {
    ...
    label: "Cochin University College of Engineering Kuttanad",
  },
  {
  ...
  { value: "Colegio Simón Bolívar", label: "Colegio Simón Bolívar" },
  { value: "Colgate University", label: "Colgate University" },
  { value: "Collège Ahuntsic", label: "Collège Ahuntsic" },
  { value: "Collège André-Grasset", label: "Collège André-Grasset" },
  {
    value: "Collège de Bois-de-Boulogne",
    label: "Collège de Bois-de-Boulogne",
  },
  { value: "Collège de Maisonneuve", label: "Collège de Maisonneuve" },
  { value: "Collège de Montréal", label: "Collège de Montréal" },
  { value: "Collège de Rosemont", label: "Collège de Rosemont" },
  { value: "Collège Français", label: "Collège Français" },
  { value: "Collège Jean-de-Brébeuf", label: "Collège Jean-de-Brébeuf" },
  { value: "Collège Jean-Eudes", label: "Collège Jean-Eudes" },
  { value: "Collège Lionel-Groulx", label: "Collège Lionel-Groulx" },
  {
    value:
  ...
  { value: "College of Westchester", label: "College of Westchester" },
  { value: "Collège Regina Assumpta", label: "Collège Regina Assumpta" },
  {
    value: "Colleyville Heritage High School",
    label: "Colleyville Heritage High School",
  },
  { value: "Collins Hill High School", label: "Collins Hill High School" },
  { value: "Colorado School of Mines", label: "Colorado School of Mines" },
  { value: "Colts Neck High School", label: "Colts Neck High School" },
  { value: "Columbia Secondary School", label: "Columbia Secondary School" },
  ...
  { value: "Comenius University", label: "Comenius University" },
  {
  ...
  { value: "Concord Academy", label: "Concord Academy" },
  ...
  { value: "Conestoga High School", label: "Conestoga High School" },
  ...
  },
  {
    ...
    label: "Cooch Behar Government Engineering College",
  },
  { value: "Cooper Union", label: "Cooper Union" },
  { value: "Coral Glades High School", label: "Coral Glades High School" },
  ...
  { value: "Cranbrook Schools", label: "Cranbrook Schools" },
  { value: "Cranfield University", label: "Cranfield University" },
  { value: "Creekview High School", label: "Creekview High School" },
  { value: "Cumberland County College", label: "Cumberland County College" },
  {
    value: "Cummins College of Engineering for Women,  Pune",
    label: "Cummins College of Engineering for Women,  Pune",
  },
  { value: "Cupertino High School", label: "Cupertino High School" },
  {
  ...
  { value: "DCS,  Ganpat University", label: "DCS,  Ganpat University" },
  ...
  { value: "Deerfield High School", label: "Deerfield High School" },
  { value: "Del Norte High School", label: "Del Norte High School" },
  {
  ...
  { value: "Digital Harbor High School", label: "Digital Harbor High School" },
  ...
  { value: "Dublin Jerome High School", label: "Dublin Jerome High School" },
  { value: "Duke University", label: "Duke University" },
  { value: "Dulaney High School", label: "Dulaney High School" },
  { value: "Duquesne University", label: "Duquesne University" },
  { value: "Durant High School", label: "Durant High School" },
  ...
  { value: "Dwight-Englewood School", label: "Dwight-Englewood School" },
  {
    value: "Earl of March Secondary School",
    label: "Earl of March Secondary School",
  },
  { value: "Earlham College", label: "Earlham College" },
  { value: "East Brunswick High School", label: "East Brunswick High School" },
  ...
  { value: "East Los Angeles College", label: "East Los Angeles College" },
  {
  ...
  { value: "ecole centrale marseille", label: "ecole centrale marseille" },
  { value: "École Centrale Paris", label: "École Centrale Paris" },
  {
  ...
  { value: "Edina High School", label: "Edina High School" },
  {
    value: "Edinburgh Napier University",
    label: "Edinburgh Napier University",
  },
  { value: "Edison Academy", label: "Edison Academy" },
  ...
  { value: "El Centro de Estudiantes", label: "El Centro de Estudiantes" },
  { value: "Elgin Academy", label: "Elgin Academy" },
  { value: "Elizabeth High School", label: "Elizabeth High School" },
  ...
  { value: "Episcopal Academy", label: "Episcopal Academy" },
  { value: "EPITECH Bordeaux", label: "EPITECH Bordeaux" },
  {
    value: "Er.Perumal Manimekalai College of Engineering",
    label: "Er.Perumal Manimekalai College of Engineering",
  },
  { value: "Erasmus Hogeschool Brussel", label: "Erasmus Hogeschool Brussel" },
  { value: "Erie Community College", label: "Erie Community College" },
  { value: "Ernest Manning High School", label: "Ernest Manning High School" },
  {
  ...
  { value: "Fairview High School", label: "Fairview High School" },
  { value: "Farmingdale State College", label: "Farmingdale State College" },
  { value: "FernUniversität in Hagen", label: "FernUniversität in Hagen" },
  {
  ...
  { value: "Fontys Hogeschool", label: "Fontys Hogeschool" },
  ...
  { value: "Francis Holland School", label: "Francis Holland School" },
  { value: "Francis Lewis High School", label: "Francis Lewis High School" },
  {
    value: "Frankford High School - Philadelphia",
    label: "Frankford High School - Philadelphia",
  },
  { value: "Franklin High School", label: "Franklin High School" },
  {
  ...
  { value: "Freehold High School", label: "Freehold High School" },
  { value: "Freire Charter High School", label: "Freire Charter High School" },
  { value: "Fremont High School", label: "Fremont High School" },
  ...
  { value: "Ganga International School", label: "Ganga International School" },
  { value: "Ganpat University", label: "Ganpat University" },
  {
    value: "Gar-Field Senior High School",
    label: "Gar-Field Senior High School",
  },
  { value: "Garnet Valley High School", label: "Garnet Valley High School" },
  ...
  { value: "GEC, Gandhinagar", label: "GEC, Gandhinagar" },
  { value: "GEC, Patan", label: "GEC, Patan" },
  {
  ...
  { value: "George Heriot's School", label: "George Heriot's School" },
  ...
  { value: "Germantown Friends School", label: "Germantown Friends School" },
  {
  ...
  { value: "Gitam School of Technology", label: "Gitam School of Technology" },
  {
    value: "GL Bajaj Institute of Technology and Management",
    label: "GL Bajaj Institute of Technology and Management",
  },
  { value: "Glassboro High School", label: "Glassboro High School" },
  {
  ...
  { value: "GOA IT INNOVATION CENTRE", label: "GOA IT INNOVATION CENTRE" },
  {
  ...
  { value: "Grady High School", label: "Grady High School" },
  {
  ...
  { value: "Greenwood College School", label: "Greenwood College School" },
  ...
  { value: "Guru Nanak Institutions", label: "Guru Nanak Institutions" },
  {
    value: "Guru Tegh Bahadur Institute of Technology (GTBIT)",
    label: "Guru Tegh Bahadur Institute of Technology (GTBIT)",
  },
  { value: "Gurukula Kangri University", label: "Gurukula Kangri University" },
  {
  ...
  { value: "H.N. Werkman College", label: "H.N. Werkman College" },
  {
  ...
  { value: "Harcum College", label: "Harcum College" },
  ...
  { value: "Harrison Career Institute", label: "Harrison Career Institute" },
  { value: "Harvard Medical School", label: "Harvard Medical School" },
  { value: "Harvard University", label: "Harvard University" },
  { value: "Harvey Mudd University", label: "Harvey Mudd University" },
  {
  ...
  { value: "Hazleton Area High School", label: "Hazleton Area High School" },
  { value: "Head-Royce School", label: "Head-Royce School" },
  { value: "Health Careers High School", label: "Health Careers High School" },
  {
  ...
  { value: "Herguan University", label: "Herguan University" },
  {
    value: "Heritage Institute of Technology",
    label: "Heritage Institute of Technology",
  },
  { value: "Het Baarnsch Lyceum", label: "Het Baarnsch Lyceum" },
  {
  ...
  { value: "Hightstown High School", label: "Hightstown High School" },
  {
  ...
  { value: "Hogeschool Thomas More", label: "Hogeschool Thomas More" },
  { value: "Hogeschool van Amsterdam", label: "Hogeschool van Amsterdam" },
  { value: "Holton-Arms School", label: "Holton-Arms School" },
  { value: "Holy Family University", label: "Holy Family University" },
  { value: "Homestead High School", label: "Homestead High School" },
  {
  ...
  { value: "Horace Furness High School", label: "Horace Furness High School" },
  { value: "Horace Mann School", label: "Horace Mann School" },
  {
    value: "Hostos Community College, CUNY",
    label: "Hostos Community College, CUNY",
  },
  { value: "Houghton High School", label: "Houghton High School" },
  ...
  {
    value: "Humber Polytechnic - Toronto",
    label: "Humber Polytechnic - Toronto",
  },
  ...
  { value: "Hussian School of Art", label: "Hussian School of Art" },
  {
  ...
  { value: "I.T.S Engineering College", label: "I.T.S Engineering College" },
  {
  ...
  { value: "Iliria College", label: "Iliria College" },
  {
  ...
  },
  {
    ...
    label: "Institute of Engineering and Technology, DAVV",
  },
  {
    value:
  ...
  { value: "Instytut Pamięci Narodowej", label: "Instytut Pamięci Narodowej" },
  {
  ...
  { value: "Istanbul University", label: "Istanbul University" },
  {
  ...
  { value: "ITM University, Vadodara", label: "ITM University, Vadodara" },
  ...
  { value: "Jacobs University Bremen", label: "Jacobs University Bremen" },
  ...
  { value: "James Madison High School", label: "James Madison High School" },
  { value: "James Madison University", label: "James Madison University" },
  { value: "Jamia Hamdard", label: "Jamia Hamdard" },
  {
  ...
  { value: "John Abbott College", label: "John Abbott College" },
  { value: "John Bartram High School", label: "John Bartram High School" },
  {
    value: "John F. Kennedy Memorial High School",
    label: "John F. Kennedy Memorial High School",
  },
  {
    value: "John Fraser Secondary School",
    label: "John Fraser Secondary School",
  },
  {
    value: "John Jay College of Criminal Justice, CUNY",
    label: "John Jay College of Criminal Justice, CUNY",
  },
  { value: "John Leggott College", label: "John Leggott College" },
  {
  ...
  { value: "Jorhat Engineering College", label: "Jorhat Engineering College" },
  {
  ...
  { value: "Julia R. Masterman School", label: "Julia R. Masterman School" },
  {
  ...
  { value: "Kansai University", label: "Kansai University" },
  ...
  { value: "KCG College of Engineering", label: "KCG College of Engineering" },
  ...
  { value: "Kennett High School", label: "Kennett High School" },
  {
  ...
  { value: "Khan Lab School", label: "Khan Lab School" },
  {
  ...
  { value: "KIPP DuBois Charter School", label: "KIPP DuBois Charter School" },
  {
  ...
  { value: "Kristu Jayanti College", label: "Kristu Jayanti College" },
  {
  ...
  { value: "Lady Doak College", label: "Lady Doak College" },
  ...
  { value: "Lakeside High School", label: "Lakeside High School" },
  {
  ...
  { value: "Lankenau High School", label: "Lankenau High School" },
  { value: "LaSalle College", label: "LaSalle College" },
  ...
  { value: "Linn-Mar High School", label: "Linn-Mar High School" },
  {
  ...
  { value: "Loch Raven High School", label: "Loch Raven High School" },
  {
  ...
  { value: "MacArthur High School", label: "MacArthur High School" },
  {
  ...
  { value: "Madison College", label: "Madison College" },
  { value: "Madison West High School", label: "Madison West High School" },
  {
  ...
  { value: "Maine South High School", label: "Maine South High School" },
  {
  ...
  { value: "Malvern Preparatory School", label: "Malvern Preparatory School" },
  { value: "Malvern Preparatory School", label: "Malvern Preparatory School" },
  {
    value: "Manakula Vinayagar Institute of Techology",
    label: "Manakula Vinayagar Institute of Techology",
  },
  { value: "Manalapan High School", label: "Manalapan High School" },
  { value: "Manav Rachna International", label: "Manav Rachna International" },
  {
  ...
  { value: "Manor College", label: "Manor College" },
  {
  ...
  { value: "Marcellus High School", label: "Marcellus High School" },
  {
    value: "Mariana Bracetti Academy Charter School",
    label: "Mariana Bracetti Academy Charter School",
  },
  { value: "Marianopolis College", label: "Marianopolis College" },
  ...
  { value: "Markville Secondary School", label: "Markville Secondary School" },
  { value: "Marlboro High School", label: "Marlboro High School" },
  { value: "Marquette University", label: "Marquette University" },
  { value: "Marshall High School", label: "Marshall High School" },
  {
  ...
  { value: "Mata Gujri College", label: "Mata Gujri College" },
  { value: "Mater Academy High School", label: "Mater Academy High School" },
  {
  ...
  { value: "Metas Adventist School", label: "Metas Adventist School" },
  {
  ...
  { value: "Metuchen High School", label: "Metuchen High School" },
  {
  ...
  { value: "Middlesex County Academy", label: "Middlesex County Academy" },
  {
  ...
  { value: "Middleton High School", label: "Middleton High School" },
  {
  ...
  { value: "Millburn High School", label: "Millburn High School" },
  { value: "Millburn Middle School", label: "Millburn Middle School" },
  {
  ...
  { value: "Mission College Boulevard", label: "Mission College Boulevard" },
  {
  ...
  { value: "Mody University", label: "Mody University" },
  ...
  { value: "Montclair High School", label: "Montclair High School" },
  ...
  { value: "Montgomery High School", label: "Montgomery High School" },
  {
  ...
  { value: "Moore Middle School", label: "Moore Middle School" },
  { value: "Moorestown High School", label: "Moorestown High School" },
  {
  ...
  { value: "Morris Hills High School", label: "Morris Hills High School" },
  { value: "Morton College", label: "Morton College" },
  {
  ...
  { value: "Mountain Lakes High School", label: "Mountain Lakes High School" },
  { value: "Mountain View High School", label: "Mountain View High School" },
  { value: "MSME TDC PPDC Agra", label: "MSME TDC PPDC Agra" },
  ...
  { value: "MVJ College of Engineering", label: "MVJ College of Engineering" },
  {
  ...
  { value: "Nashua High School South", label: "Nashua High School South" },
  {
  ...
  { value: "New Albany High School", label: "New Albany High School" },
  {
  ...
  { value: "New Providence High School", label: "New Providence High School" },
  {
  ...
  { value: "Newark Charter High School", label: "Newark Charter High School" },
  {
  ...
  { value: "Newton South High School", label: "Newton South High School" },
  ...
  { value: "Noor-ul-Iman", label: "Noor-ul-Iman" },
  { value: "Norco College", label: "Norco College" },
  ...
  { value: "North Andover High School", label: "North Andover High School" },
  {
  ...
  { value: "North Penn High School", label: "North Penn High School" },
  {
  ...
  { value: "Northeastern University", label: "Northeastern University" },
  {
    ...
    label: "Northern Alberta Institute of Technology (NAIT)",
  },
  {
  ...
  { value: "Northview High School", label: "Northview High School" },
  {
  ...
  { value: "Northwest Vista College", label: "Northwest Vista College" },
  {
  ...
  { value: "NSS College of Engineering", label: "NSS College of Engineering" },
  ...
  { value: "Ocean City High School", label: "Ocean City High School" },
  ...
  { value: "Old Westbury, SUNY", label: "Old Westbury, SUNY" },
  { value: "Olney High School", label: "Olney High School" },
  { value: "Onalaska High School", label: "Onalaska High School" },
  ...
  { value: "Orissa Engineering College", label: "Orissa Engineering College" },
  {
    value: "Orleans Technical Institute",
    label: "Orleans Technical Institute",
  },
  { value: "Osbourn Park High School", label: "Osbourn Park High School" },
  {
  ...
  { value: "Oxford Academy High School", label: "Oxford Academy High School" },
  ...
  { value: "Parkview High School", label: "Parkview High School" },
  {
    value: "Parkway Center City High School",
    label: "Parkway Center City High School",
  },
  { value: "Parkway West High School", label: "Parkway West High School" },
  { value: "Parsippany High School", label: "Parsippany High School" },
  { value: "Parsons School of Design", label: "Parsons School of Design" },
  {
  ...
  { value: "Pathways School Noida", label: "Pathways School Noida" },
  {
  ...
  { value: "PDM College of Engineering", label: "PDM College of Engineering" },
  ...
  { value: "Penncrest High School", label: "Penncrest High School" },
  { value: "Pennington School", label: "Pennington School" },
  {
  ...
  { value: "Perth Amboy High School", label: "Perth Amboy High School" },
  {
  ...
  { value: "Pingree School", label: "Pingree School" },
  {
  ...
  { value: "Plaksha University", label: "Plaksha University" },
  {
    value: "Plano East Senior High School",
    label: "Plano East Senior High School",
  },
  { value: "Plovdiv Medical University", label: "Plovdiv Medical University" },
  {
  ...
  { value: "Politecnico di Milano", label: "Politecnico di Milano" },
  {
  ...
  { value: "Poolesville High School", label: "Poolesville High School" },
  {
  ...
  { value: "Porter-Gaud School", label: "Porter-Gaud School" },
  { value: "Portland State University", label: "Portland State University" },
  { value: "Potomac Senior High School", label: "Potomac Senior High School" },
  { value: "Potsdam, SUNY", label: "Potsdam, SUNY" },
  {
  ...
  { value: "Presidency School, Surat.", label: "Presidency School, Surat." },
  { value: "Preston High School", label: "Preston High School" },
  { value: "Preston University", label: "Preston University" },
  { value: "Princeton Day School", label: "Princeton Day School" },
  ...
  { value: "Punjab University, Patiala", label: "Punjab University, Patiala" },
  ...
  { value: "Queens College, CUNY", label: "Queens College, CUNY" },
  {
  ...
  { value: "Radnor High School", label: "Radnor High School" },
  {
  ...
  { value: "Raksha Shakti University", label: "Raksha Shakti University" },
  {
  ...
  { value: "Ramapo High School", label: "Ramapo High School" },
  {
  ...
  { value: "Raritan High School", label: "Raritan High School" },
  {
  ...
  { value: "Ravenscroft School", label: "Ravenscroft School" },
  { value: "Ravenwood High School", label: "Ravenwood High School" },
  { value: "Reach Cyber Charter School", label: "Reach Cyber Charter School" },
  {
  ...
  { value: "Regis High School", label: "Regis High School" },
  {
  ...
  { value: "Richardson High School", label: "Richardson High School" },
  ...
  { value: "Ridge High School", label: "Ridge High School" },
  { value: "Ridgewood High School", label: "Ridgewood High School" },
  ...
  { value: "River Dell High School", label: "River Dell High School" },
  { value: "RMK College of Engineering", label: "RMK College of Engineering" },
  {
    value: "RNS Institute of Technology",
    label: "RNS Institute of Technology",
  },
  { value: "Robbinsville High School", label: "Robbinsville High School" },
  ...
  { value: "Rock Ridge High School", label: "Rock Ridge High School" },
  { value: "Roger Williams University", label: "Roger Williams University" },
  { value: "Rollins College", label: "Rollins College" },
  { value: "Roosevelt High School", label: "Roosevelt High School" },
  { value: "Rosa Parks Middle School", label: "Rosa Parks Middle School" },
  {
  ...
  { value: "Roxborough High School", label: "Roxborough High School" },
  { value: "Roxbury High School", label: "Roxbury High School" },
  {
    value: "Royal Holloway, University of London",
    label: "Royal Holloway, University of London",
  },
  { value: "RPIIT Technical Campus", label: "RPIIT Technical Campus" },
  { value: "Rudbecksgymnasiet", label: "Rudbecksgymnasiet" },
  {
  ...
  { value: "Rutgers Preparatory School", label: "Rutgers Preparatory School" },
  {
  ...
  { value: "Ryde School", label: "Ryde School" },
  { value: "Rye High School", label: "Rye High School" },
  { value: "Ryerson University", label: "Ryerson University" },
  { value: "S A Engineering College", label: "S A Engineering College" },
  {
  ...
  { value: "Saint Paul College", label: "Saint Paul College" },
  {
  ...
  { value: "Salem Community College", label: "Salem Community College" },
  { value: "Salem State University", label: "Salem State University" },
  {
    ...
    label: "Sambalpur University Institute of Information Technology (SUIIT)",
  },
  {
  ...
  { value: "San Marcos High School", label: "San Marcos High School" },
  { value: "San Marin High School", label: "San Marin High School" },
  ...
  { value: "Science Leadership Academy", label: "Science Leadership Academy" },
  { value: "Scranton High School", label: "Scranton High School" },
  { value: "Seneca College", label: "Seneca College" },
  { value: "Seton Hall University", label: "Seton Hall University" },
  { value: "Seven Lakes High School", label: "Seven Lakes High School" },
  {
    value: "Seventh Day Adventist High School",
    label: "Seventh Day Adventist High School",
  },
  { value: "Shaker High School", label: "Shaker High School" },
  {
  ...
  { value: "Shelton High School", label: "Shelton High School" },
  { value: "Sheridan College", label: "Sheridan College" },
  { value: "Sherwood Convent School", label: "Sherwood Convent School" },
  { value: "Sherwood High School", label: "Sherwood High School" },
  ...
  { value: "Simón Bolívar University", label: "Simón Bolívar University" },
  { value: "Simon Fraser University", label: "Simon Fraser University" },
  { value: "Simon Gratz High School", label: "Simon Gratz High School" },
  { value: "Simpson College", label: "Simpson College" },
  { value: "Simsbury High School", label: "Simsbury High School" },
  ...
  { value: "SKR Engineering College", label: "SKR Engineering College" },
  {
  ...
  { value: "Solebury School", label: "Solebury School" },
  { value: "Sona College of Technology", label: "Sona College of Technology" },
  { value: "Souderton Area High School", label: "Souderton Area High School" },
  {
  ...
  { value: "South Lakes High School", label: "South Lakes High School" },
  {
  ...
  { value: "Spelman College", label: "Spelman College" },
  { value: "Spotswood High School", label: "Spotswood High School" },
  ...
  },
  {
    ...
    label: "Sri Venkateshwara College of Engineering",
  },
  {
  ...
  { value: "SRM University, Sonepat", label: "SRM University, Sonepat" },
  { value: "SS College of Engineering", label: "SS College of Engineering" },
  { value: "St Brendan High School", label: "St Brendan High School" },
  ...
  },
  {
    ...
    label: "St. Joseph's College of Engineering and Technology, Palai",
  },
  {
    value: "St. Mark's School, Hong Kong",
    label: "St. Mark's School, Hong Kong",
  },
  { value: "St. Mary's Convent School", label: "St. Mary's Convent School" },
  {
  ...
  {
    value: "St. Robert Catholic High School",
    label: "St. Robert Catholic High School",
  },
  {
  ...
  { value: "Star Technical Institute", label: "Star Technical Institute" },
  {
  ...
  { value: "Steinert High School", label: "Steinert High School" },
  {
  ...
  { value: "Stuyvesant High School", label: "Stuyvesant High School" },
  { value: "Sulphur High School", label: "Sulphur High School" },
  ...
  { value: "Susq-Cyber Charter School", label: "Susq-Cyber Charter School" },
  ...
  { value: "SVS College of Engineering", label: "SVS College of Engineering" },
  {
    value:
  ...
  { value: "Tacoma Community College", label: "Tacoma Community College" },
  {
  ...
  { value: "Temple University - Ambler", label: "Temple University - Ambler" },
  {
  ...
  { value: "Temple University - Rome", label: "Temple University - Rome" },
  { value: "Temple University - Tokyo", label: "Temple University - Tokyo" },
  { value: "Tenafly High School", label: "Tenafly High School" },
  ...
  { value: "The Harker School", label: "The Harker School" },
  { value: "The Hill School", label: "The Hill School" },
  {
    value: "The Katholieke Universiteit Leuven",
    label: "The Katholieke Universiteit Leuven",
  },
  { value: "The Lawrenceville School", label: "The Lawrenceville School" },
  {
  ...
  { value: "The Roxbury Latin School", label: "The Roxbury Latin School" },
  {
    value: "The Savannah College of Art and Design",
    label: "The Savannah College of Art and Design",
  },
  { value: "The SRM University", label: "The SRM University" },
  {
  ...
  { value: "The University of Aberdeen", label: "The University of Aberdeen" },
  ...
  { value: "The University of Alberta", label: "The University of Alberta" },
  {
  ...
  { value: "The University of Arkansas", label: "The University of Arkansas" },
  { value: "The University of Bath", label: "The University of Bath" },
  {
  ...
  { value: "The University of Bolton", label: "The University of Bolton" },
  { value: "The University of Bonn", label: "The University of Bonn" },
  { value: "The University of Bristol", label: "The University of Bristol" },
  {
    value: "The University of British Columbia",
    label: "The University of British Columbia",
  },
  { value: "The University of Calgary", label: "The University of Calgary" },
  { value: "The University of Calicut", label: "The University of Calicut" },
  {
  ...
  { value: "The University of Chicago", label: "The University of Chicago" },
  {
  ...
  { value: "The University of Delaware", label: "The University of Delaware" },
  { value: "The University of Denver", label: "The University of Denver" },
  { value: "The University of Derby", label: "The University of Derby" },
  { value: "The University of Dundee", label: "The University of Dundee" },
  {
    value: "The University of Edinburgh",
    label: "The University of Edinburgh",
  },
  { value: "The University of Essex", label: "The University of Essex" },
  {
  ...
  { value: "The University of Falmouth", label: "The University of Falmouth" },
  { value: "The University of Florida", label: "The University of Florida" },
  { value: "The University of Gdańsk", label: "The University of Gdańsk" },
  { value: "The University of Georgia", label: "The University of Georgia" },
  { value: "The University of Glasgow", label: "The University of Glasgow" },
  {
    value: "The University of Groningen",
    label: "The University of Groningen",
  },
  { value: "The University of Guelph", label: "The University of Guelph" },
  { value: "The University of Houston", label: "The University of Houston" },
  {
  ...
  { value: "The University of Idaho", label: "The University of Idaho" },
  {
  ...
  { value: "The University of Iowa", label: "The University of Iowa" },
  { value: "The University of Kansas", label: "The University of Kansas" },
  { value: "The University of Kent", label: "The University of Kent" },
  { value: "The University of Kentucky", label: "The University of Kentucky" },
  { value: "The University of La Verne", label: "The University of La Verne" },
  { value: "The University of Leeds", label: "The University of Leeds" },
  {
    value: "The University of Leicester",
    label: "The University of Leicester",
  },
  { value: "The University of Lincoln", label: "The University of Lincoln" },
  {
  ...
  { value: "The University of Málaga", label: "The University of Málaga" },
  {
    value: "The University of Manchester",
    label: "The University of Manchester",
  },
  { value: "The University of Manitoba", label: "The University of Manitoba" },
  {
  ...
  { value: "The University of Miami", label: "The University of Miami" },
  { value: "The University of Michigan", label: "The University of Michigan" },
  {
  ...
  { value: "The University of Missouri", label: "The University of Missouri" },
  {
  ...
  { value: "The University of Oregon", label: "The University of Oregon" },
  { value: "The University of Ottawa", label: "The University of Ottawa" },
  { value: "The University of Oulu", label: "The University of Oulu" },
  { value: "The University of Oxford", label: "The University of Oxford" },
  {
  ...
  { value: "The University of Phoenix", label: "The University of Phoenix" },
  {
    value: "The University of Pittsburgh",
    label: "The University of Pittsburgh",
  },
  { value: "The University of Portland", label: "The University of Portland" },
  {
  ...
  { value: "The University of Richmond", label: "The University of Richmond" },
  {
    value: "The University of Rochester",
    label: "The University of Rochester",
  },
  { value: "The University of Salford", label: "The University of Salford" },
  {
  ...
  { value: "The University of Stirling", label: "The University of Stirling" },
  {
  ...
  { value: "The University of Surrey", label: "The University of Surrey" },
  { value: "The University of Sussex", label: "The University of Sussex" },
  ...
  },
  {
    ...
    label: "The University of the West Indies",
  },
  { value: "The University of Toledo", label: "The University of Toledo" },
  { value: "The University of Toronto", label: "The University of Toronto" },
  {
  ...
  { value: "The University of Vermont", label: "The University of Vermont" },
  { value: "The University of Victoria", label: "The University of Victoria" },
  { value: "The University of Virginia", label: "The University of Virginia" },
  { value: "The University of Warsaw", label: "The University of Warsaw" },
  ...
  { value: "The University of Waterloo", label: "The University of Waterloo" },
  {
  ...
  { value: "The University of Windsor", label: "The University of Windsor" },
  {
  ...
  { value: "The University of Wrocław", label: "The University of Wrocław" },
  { value: "The University of York", label: "The University of York" },
  { value: "The University of Zagreb", label: "The University of Zagreb" },
  {
  ...
  { value: "Towson High School", label: "Towson High School" },
  ...
  { value: "Trinity Valley School", label: "Trinity Valley School" },
  { value: "Troy Athens High School", label: "Troy Athens High School" },
  ...
  { value: "Universidad de Guadalajara", label: "Universidad de Guadalajara" },
  { value: "Universidad de Guanajuato", label: "Universidad de Guanajuato" },
  { value: "Universidad de La Laguna", label: "Universidad de La Laguna" },
  {
    value: "Universidad de La Salle Bajío",
    label: "Universidad de La Salle Bajío",
  },
  { value: "Universidad de Monterrey", label: "Universidad de Monterrey" },
  ...
  { value: "Universidad Iberoamericana", label: "Universidad Iberoamericana" },
  {
  ...
  { value: "Universidad Panamericana", label: "Universidad Panamericana" },
  {
  ...
  { value: "Universidad TecMilenio", label: "Universidad TecMilenio" },
  {
  ...
  { value: "Universidad Veracruzana", label: "Universidad Veracruzana" },
  {
  ...
  { value: "Universität Zürich", label: "Universität Zürich" },
  {
    value: "Universitatea Politehnica Timişoara",
    label: "Universitatea Politehnica Timişoara",
  },
  { value: "Université de Bordeaux", label: "Université de Bordeaux" },
  { value: "Université de Mons", label: "Université de Mons" },
  ...
  { value: "University at Orange, SUNY", label: "University at Orange, SUNY" },
  { value: "University at Oswego, SUNY", label: "University at Oswego, SUNY" },
  {
    value: "University at Plattsburgh, SUNY",
    label: "University at Plattsburgh, SUNY",
  },
  { value: "University Campus Suffolk", label: "University Campus Suffolk" },
  ...
  { value: "University of Basel", label: "University of Basel" },
  { value: "University of Białystok", label: "University of Białystok" },
  {
    value: "University of Cape Coast, Ghana",
    label: "University of Cape Coast, Ghana",
  },
  ...
  { value: "University of Trento", label: "University of Trento" },
  { value: "University of Udaipur", label: "University of Udaipur" },
  ...
  { value: "Upper Darby High School", label: "Upper Darby High School" },
  { value: "Upper Iowa University", label: "Upper Iowa University" },
  { value: "Upper Moreland High School", label: "Upper Moreland High School" },
  { value: "Urbana High School", label: "Urbana High School" },
  ...
  { value: "Valley High School", label: "Valley High School" },
  {
    value:
  ...
  { value: "Vanier College", label: "Vanier College" },
  {
  ...
  { value: "VIA University College", label: "VIA University College" },
  {
  ...
  { value: "Vidyagyan School", label: "Vidyagyan School" },
  {
  ...
  { value: "Virtual High School @ PWCS", label: "Virtual High School @ PWCS" },
  {
  ...
  { value: "VNS Group of Institutions", label: "VNS Group of Institutions" },
  {
  ...
  { value: "Walt Whitman High School", label: "Walt Whitman High School" },
  {
    value: "Walter Biddle Saul High School",
    label: "Walter Biddle Saul High School",
  },
  { value: "Ward Melville High School", label: "Ward Melville High School" },
  { value: "Wardlaw + Hartridge School", label: "Wardlaw + Hartridge School" },
  {
    value: "Warren County Technical High School",
    label: "Warren County Technical High School",
  },
  { value: "Warsaw School of Economics", label: "Warsaw School of Economics" },
  {
  ...
  { value: "Waunakee High School", label: "Waunakee High School" },
  ...
  { value: "West Chester University", label: "West Chester University" },
  {
  ...
  { value: "West Potomac High School", label: "West Potomac High School" },
  { value: "West Scranton High School", label: "West Scranton High School" },
  {
  ...
  { value: "Western Technical College", label: "Western Technical College" },
  { value: "Western University", label: "Western University" },
  {
    value: "Western Washington University",
    label: "Western Washington University",
  },
  { value: "Westfield High School", label: "Westfield High School" },
  { value: "Westminster College", label: "Westminster College" },
  { value: "Westminster School", label: "Westminster School" },
  { value: "Westwood High School", label: "Westwood High School" },
  { value: "Whitefish Bay High School", label: "Whitefish Bay High School" },
  ...
  { value: "Wiltshire College", label: "Wiltshire College" },
